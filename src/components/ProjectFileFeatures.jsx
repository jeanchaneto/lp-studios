...
const features = [
  ...
  },
  {
    ...
    description: 'Understand the fine details of balancing elements, intricate automations, and effective FX use, all in a single, professionally arranged track.',
    icon: "/icons/mixer.png",
  },
  {
    name: 'Ready to use',
    description: 'All audio and midi tracks are frozen to ensure compatibility, letting you dissect the project even without owning every plugin used.',
...
const ProjectFileFeatures = () => {
  return (
    <div className="overflow-hidden bg-zinc-950 py-24 sm:py-32">
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base text-zinc-400 lg:max-w-none">
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    ...
                    <Image src={feature.icon}  height={20} width={20} className="absolute left-1 top-1 " alt={`${feature.name} icon`} />
                      {feature.name}
                    </dt>{' '}
