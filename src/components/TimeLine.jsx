...
const timelineData = [
  ...
  },
  {
    ...
    description: "Once you are completely satisfied with the demo, a secure payment link will be sent to you.",
    isActive: true,
  },
  {
    id: 4,
    ...
    <section className=" bg-zinc-950 mt-24 ">
      ...
      {timelineData.map((item) => (
        <div key={item.id} className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group ${item.isActive ? "is-active" : ""}`}>
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-zinc-900 p-4 rounded border border-zinc-100/20 shadow">
