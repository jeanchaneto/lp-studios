    ...
    <section className="">
      <FadeIn>
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8 relative">
          <div
            className="relative isolate border border-zinc-100/10   px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16 group/cta "
          ...
          `,
            ...
            <p className="mx-auto max-w-xl mt-4 text-zinc-400 text-base ">
              Take your music to the next level with our custom ghost production
              services. Get tracks tailor-made to your style and vision,
              produced to industry-leading standards.
            </p>
