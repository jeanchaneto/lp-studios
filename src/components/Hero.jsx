      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        ...
        <h2 className="text-base font-semibold leading-7 text-zinc-300">Afro House | Melodic Techno | Organic House | Deep House</h2>
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="#"
              className="rounded-md bg-cyan-700 px-3.5 py-2.5 text-sm font-semibold text-zinc-100 hover:bg-cyan-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 
