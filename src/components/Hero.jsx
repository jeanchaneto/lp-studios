  ...
  return (
    <section className="relative isolate pt-14 bg-zinc-950 ">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        ...
        <h2 className="text-base font-semibold leading-7 text-teal-700">Afro House | Melodic house & Techno | Organic House | Deep House</h2>
          ...
          <p className="mt-6 text-xl leading-8 text-zinc-400">
            ...
            we're the pulse of melodic house & techno, afro house, and organic house.
