          ...
          <CardBody className=" ">
            <div className="relative mb-2 min-[340px]:mb-6 z-20 bg-zinc-950 rounded-xl group/image ">
              <div className=" relative">
                ...
                <Image src={props.image} alt="Album cover"  /></div>
                <p className=" z-40 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-4xl font-kallisto font-bold tracking-widest text-red-700 border-3 border-red-700 rounded xl py-2 px-1.5 " >SOLD</p>
              </div>
            </div>
